...
* <<Create a deployment plan based on an existing plan,Implementar un sistema en la nube basado en un plan de implementación existente que tenga requisitos similares.>>
