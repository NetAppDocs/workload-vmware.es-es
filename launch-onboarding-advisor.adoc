...
Al migrar a VMware Cloud, puede utilizar el asesor de migración para migrar su entorno vSphere local actual a la nube de VMware.
...
. Seleccione el tipo de archivo de inventario que utilizará para completar Workload Factory con su configuración de VM actual y seleccione *Siguiente*.
+
