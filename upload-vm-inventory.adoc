...
+
Se muestra el centro de planificación. Desde el centro de planificación, puede cargar los datos de inventario de sus máquinas virtuales, ver cargas de datos de inventario anteriores y planificar una migración utilizando cualquiera de los conjuntos de datos de inventario de máquinas virtuales.
...
en el https://www.dell.com/en-us/shop/vmware/sl/rvtools["Obtenga más información sobre RVTools"^]
...
. Descarga e instala RVTools 4.4.2 o superior desde el https://www.dell.com/en-us/shop/vmware/sl/rvtools["Sitio web de RVTools"^]
...
+
Consulte el capítulo sobre "parámetros de línea de comandos" en el https://www.dell.com/en-us/shop/vmware/sl/rvtools["La documentación de RVTools se encuentra en la sección de Recursos."^] Para más detalles.
...
* link:launch-migration-advisor-gcve.html["Crea un plan de implementación de Google Cloud VMware Engine"]
