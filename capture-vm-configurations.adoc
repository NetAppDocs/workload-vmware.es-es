...
---
= Capture las configuraciones actuales de sus máquinas virtuales
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
. En el mosaico de VMware, seleccione *Planificar e implementar*.
+
image:screenshot-choose-method.png["Una captura de pantalla de los diferentes métodos que puede utilizar para recopilar la información de configuración de la VM actual."]
...
.. Ejecute el script de recopilador de datos que descargó y especifique la opción de recopilación de datos para las estadísticas de máquinas virtuales «diarias» o «por hora».
+
...
+
Consulte el capítulo sobre “Parámetros de línea de comandos” en la https://resources.robware.net/resources/prod/RVTools.pdf["Documentación de RVTools"^] para obtener más detalles.
...
====
.El futuro
link:launch-onboarding-advisor.html["Cree un plan de despliegue con el asesor de migración"].
